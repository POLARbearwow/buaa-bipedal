...
class BuaaQ1FlatEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    # JointPositionToLimitsActionCfg resolves joints in articulation order.
    action_joint_names = [
        "hip_yaw_l",
        "hip_yaw_r",
        "hip_roll_l",
    ...
    def __post_init__(self):
        ...
        # Map normalized policy actions directly to each joint's soft position
        # limits.  This prevents large unbounded position targets such as
        # ``default_joint_pos + action * 0.5`` when the actor output drifts.
